<div class="container px-2 py-4">
  ...
  foreach( $icsEvents as $icsEvent){
          ...
          if ($dateNow > $startDt){
            ...
            $html .= '<tr class="mt-3"><td><span class="oi oi-calendar"></span> &nbsp; '.$startDate.'<br><span class="oi oi-clock"></span> &nbsp; '.$startTime.'-'.$endTime.'<br><span class="oi oi-map-marker"></span> &nbsp; &nbsp;'.$eventLoc.'</td><td><span class="text-primary font-weight-bold">'.$eventName.'</span><br><span class="text-success"><span class="oi oi-person"></span> &nbsp; '.$eventSpkr.'</span><br><span class="text-secondary"><span class="oi oi-briefcase"></span> &nbsp; '.$eventInst.'</span><br>'.$eventAbstr.'</td></tr>';
          }
